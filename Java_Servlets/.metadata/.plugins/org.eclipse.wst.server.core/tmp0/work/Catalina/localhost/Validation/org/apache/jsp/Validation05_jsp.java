 ...
 * Generated at: 2022-03-21 07:50:57 UTC
...
public final class Validation05_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("			var regExpPhone = /^\\d{3}-\\d{3,4}-\\d{4}$/		//10진수 3~4자리 \n");
      out.write("			var regExpEmail = /^[0-9a-zA-Z]([-_\\.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_\\.]?[0-9a-zA-Z])*\\.[a-zA-Z]{2,3}$/i\n");
      out.write("			\n");
      out.write("			var form = document.member	//body의 이 \n");
      out.write("			\n");
      out.write("			var id = form.id.value\n");
      out.write("			if(!regExpId.test(id)) {		// if not\n");
      ...
      out.write("	<form action=\"Validation05P.jsp\" name=\"member\" method=\"post\">\n");
      ...
      out.write("		<input type=\"button\" value=\"확인하기\" onclick=\"checkMember()\">\n");
      out.write("	</form>\n");
      out.write("</body>\n");
      out.write("</html>");
