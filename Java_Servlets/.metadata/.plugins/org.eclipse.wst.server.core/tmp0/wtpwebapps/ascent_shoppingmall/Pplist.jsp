...
<head>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.8.0/font/bootstrap-icons.css"><%-- 아이콘 --%>
		  ...
		  <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
		  		...
		  		<c:forEach items="${appList }" var="dto"><%--반복문,dto --%>
                            <!-- Product image-->
                            <a class="" href="/Pplist.view.do"></a><img class="card-img-top" src="${dto.productImages}" alt="" width="100%"/>
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    ...
                                    <!-- Product size-->
                             		<p class="pd.size">${dto.productSize }</p>
                                    <!-- Product price-->
                             		<p class="pd.price">${dto.productPrice }</p>
                                </div>
                            </div>
                 </c:forEach>
                            <!-- Product actions-->
